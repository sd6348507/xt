...
class DepartmentSearchViewModel : BaseViewModel() {
    ...
    // 源数据
    // 用于搜索过滤
    private var origList = listOf<Department>()

    private val _searchFlow = MutableStateFlow("")

    var comNo: String = ""

    val adapter = DepartmentSearchAdapter().apply {
    ...
    fun refreshData() {
        viewModelScope.launch {
            repository.fetchDepartmentList(comNo)
    ...
    fun setAdapterData(list: List<Department>) {
